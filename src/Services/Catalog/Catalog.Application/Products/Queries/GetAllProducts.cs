...
{
    public record GetAllProductsRequest() : PaginationParameters(), IRequest<PaginatedList<ProductDto>>;

    internal sealed class GetAllProductsHandler : IRequestHandler<GetAllProductsRequest, PaginatedList<ProductDto>>
    {
